...
<html>
	...
	<body class="subpage">
		...
		<artical style="display:flex; margin: 80px;">
			<form action="new_avatar.php" method="POST" style="margin: 0 auto; " enctype="multipart/form-data">
				<h2 class="ct">New avatar</h2><hr /><p/>
				...
				<label for="up_imgFile" class="ct">点击上传头像</label>
				<hr class="cneter"/>
